    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card><CardHeader><CardTitle>Transactions</CardTitle></CardHeader><CardContent><p className="text-muted-foreground text-sm mb-4">View deposits, orders & refunds</p><Button className="w-full" onClick={() => navigate("/transactions")}>View History</Button></CardContent></Card>
